    ...
    public static class ThemeManager
    {
        public static void ApplyTheme(string theme)
        {
            ...
            if (theme == "Dark")
            {
                ...
                resources["ForegroundSecondaryBrush"] = new SolidColorBrush(
                    Color.FromRgb(156, 163, 175)
                ); // #9CA3AF
                resources["ConsoleForegroundBrush"] = new SolidColorBrush(
            ...
            else // Light
            {
                ...
                resources["NavbarBackgroundBrush"] = new SolidColorBrush(
